...
export default function NewSurveyPage() {
  ...
  async function handleSubmit(e) {
    ...
    const expiresAt = new Date(Date.now() + 60 * 60 * 1000).toISOString() // 1 jam dari sekarang
    ...
    if (error) {
      alert('Gagal membuat link. Coba lagi.')
      setLoading(false)
      return
    }
  ...
  function shareWA() {
    const msg = encodeURIComponent(`Halo ${form.name}, berikut link survey kepribadian finansial dari saya. Mohon diisi dalam 1 jam ya 🙏\n\n${result.surveyUrl}`)
      ...
      <div style={s.wrap}>
        ...
        <div style={s.formCard}>
          <form onSubmit={handleSubmit} style={s.form}>
            ...
            <div style={s.note}>
              Link survey akan aktif selama <strong>1 jam</strong> setelah dibuat. Pastikan nasabah langsung mengisinya.
            </div>
...
const s = {
  ...
  submitBtn: { padding:'12px', background:'#C0392B', color:'#fff', border:'none', borderRadius:'8px', fontSize:'14px', fontWeight:'600', cursor:'pointer' },
